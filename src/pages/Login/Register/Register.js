...
const handelOnChange=(e)=>{   
   ...
   console.log(inputName , inputValue,newLoginData)
...
const handelLoginSubmit=(e)=>{
   if(loginData.passwordInput !== loginData.passwordInput2){
       alert('Your password not match')
       return
    }
    else{
        alert('good. match password ')
    }
   e.reset()
   e.preventDefault()
}
          ...
          <Grid item xs={12} md={6} sx={{ mt: 8}}>
            ...
            >
             ...
             <TextField
              ...
              <NavLink  to="/login"><Button variant="text" sx={{mt:1,wordSpacing:1}}>Already Login? GO To Login</Button>
              </NavLink>
              </form>
            </Box>
